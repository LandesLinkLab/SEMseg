function varargout = nrsegGUI_v3(varargin)
% NRSEGGUI_V3 MATLAB code for nrsegGUI_v3.fig
%      NRSEGGUI_V3, by itself, creates a new NRSEGGUI_V3 or raises the existing
%      singleton*.
%
%      H = NRSEGGUI_V3 returns the handle to a new NRSEGGUI_V3 or the handle to
%      the existing singleton*.
%
%      NRSEGGUI_V3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in NRSEGGUI_V3.M with the given input arguments.
%
%      NRSEGGUI_V3('Property','Value',...) creates a new NRSEGGUI_V3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before nrsegGUI_v3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to nrsegGUI_v3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help nrsegGUI_v3

% Last Modified by GUIDE v2.5 14-Aug-2019 12:24:59

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @nrsegGUI_v3_OpeningFcn, ...
                   'gui_OutputFcn',  @nrsegGUI_v3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before nrsegGUI_v3 is made visible.
function nrsegGUI_v3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to nrsegGUI_v3 (see VARARGIN)

% Choose default command line output for nrsegGUI_v3
...
% UIWAIT makes nrsegGUI_v3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = nrsegGUI_v3_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes on button press in pushbutton_resetcrop.
function pushbutton_resetcrop_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_resetcrop (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in radiobutton_customcrop.
function radiobutton_customcrop_Callback(hObject, eventdata, handles)
% hObject    handle to radiobutton_customcrop (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of radiobutton_customcrop
...
% --- Executes on button press in radiobutton_parammode.
function radiobutton_parammode_Callback(hObject, eventdata, handles)
% hObject    handle to radiobutton_parammode (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of radiobutton_parammode
...
function focusidx_txt_Callback(hObject, eventdata, handles)
% hObject    handle to focusidx_txt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of focusidx_txt as text
%        str2double(get(hObject,'String')) returns contents of focusidx_txt as a double


% --- Executes during object creation, after setting all properties.
function focusidx_txt_CreateFcn(hObject, eventdata, handles)
% hObject    handle to focusidx_txt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function numaggs_txt_Callback(hObject, eventdata, handles)
% hObject    handle to numaggs_txt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of numaggs_txt as text
%        str2double(get(hObject,'String')) returns contents of numaggs_txt as a double


% --- Executes during object creation, after setting all properties.
function numaggs_txt_CreateFcn(hObject, eventdata, handles)
% hObject    handle to numaggs_txt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in addagg_btn.
function addagg_btn_Callback(hObject, eventdata, handles)
% hObject    handle to addagg_btn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in subagg_btn.
function subagg_btn_Callback(hObject, eventdata, handles)
% hObject    handle to subagg_btn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes on button press in getalloutput_button.
function getalloutput_button_Callback(hObject, eventdata, handles)
% hObject    handle to getalloutput_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in pushbutton_resetParams.
function pushbutton_resetParams_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_resetParams (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in togglebutton_parammode.
function togglebutton_parammode_Callback(hObject, eventdata, handles)
% hObject    handle to togglebutton_parammode (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of togglebutton_parammode
...
% --------------------------------------------------------------------
function menu_defcrop_Callback(hObject, eventdata, handles)
% hObject    handle to menu_defcrop (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
